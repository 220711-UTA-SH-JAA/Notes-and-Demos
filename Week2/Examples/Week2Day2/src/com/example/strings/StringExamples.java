...
public class StringExamples {
	 ...
	 * - Allows developers to create mutable strings
	 * 	- Store a mutable sequence of characters
	 * 	- Allows you to
	 * 		- append()
	 * 		- delete()
	 * 		- return the sequence as a string
	 * The difference between StringBuilder and StringBuffer
	 * 	- Builder is not Threadsafe, aka, not advised to be used when multithreading
	 * 	- Buffer is Threadsafe, aka, is advised to be used when multithreading
	 * 
	 */
	...
	public static void main(String args[]) {
		...
		//If the value in the constructor is NOT in the string pool already, it will add it
